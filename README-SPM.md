...
```swift
.package(url: "https://github.com/alqindiirsyam-es/NexilisLite.git", from: "5.1.18")
```
...
# Tag the version. SwiftPM accepts either "5.1.18" or "v5.1.18" — pick one
...
cd /tmp/NexilisLite && git tag 5.1.18 && git push origin 5.1.18
```
