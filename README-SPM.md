...
```swift
.package(url: "https://github.com/alqindiirsyam-es/NexilisLite.git", from: "5.1.13")
```
...
# Tag the version. SwiftPM accepts either "5.1.13" or "v5.1.13" — pick one
...
cd /tmp/NexilisLite && git tag 5.1.13 && git push origin 5.1.13
```
